...
local names = { "main", "www", "work", "1", "2", "3", "7", "8", "9" }
--local l = awful.layout.suit  -- Just to save some typing: use an alias.
--local layouts = { l.magnifier, l.tile.left, l.tile.left, l.fair, l.max,
--    l.floating, l.tile.left, l.floating, l.floating }
--awful.tag( layouts)

awful.util.tagnames = names --{ "1", "2", "3", "4", "5","6" }
