...
--local wallpaper_folder = os.getenv("HOME")
local wallpaper_folder = os.getenv("HOME") .. "/Pictures/Wallpapers_3440x1440"

local theme                                     = {}
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/multicolor"
--theme.wallpaper                                 = theme.confdir .. "/wall.png"
theme.wallpaper                                 = wallpaper_folder .. "/amazing_asiatic_landscape_3440x1440.jpg"
